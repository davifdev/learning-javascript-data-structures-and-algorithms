...
Uma fila é uma coleção de elementos ordenada baseada em FIFO (First In First Out) também conhecido como o princípio do first-come first-served (o primeiro a chegar é o primeiro a ser servido). A adição de novos elementos em uma fila é feita na cauda (tail), e a remoção, na frente.
