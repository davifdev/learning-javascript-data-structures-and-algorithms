...
import { BinarySearchTree } from "./binnary-search-tree";
    ...
    while (
      ...
      if (grandParent && grandParent.left == parent) {
        ...
        if (uncle && uncle.color == Colors.RED) {
          ...
          // caso 2A: o nó é o filho á direita - rotação á esquerda
          if (node === parent.right) {
            this.rotationRR(parent);
            node = parent;
            parent = node.parent;
          }
          // caso 3A: o nó é o filho á esquerda - rotação á direita
        ...
        if (uncle && uncle.color === Colors.RED) {
          ...
          // caso 2B: o nó é o filho á esquerda - rotação á direita
          if (node === parent.left) {
            this.rotationLL(parent);
            node = parent;
            parent = node.parent;
          }
          // caso 3B: o nó é o filho á direita - rotação á esqurda
